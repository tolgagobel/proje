...
<head>
    ...
    <meta charset="utf-8" />
    <title>Giriş | Haber Sitesi</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        ...
                        <p class="mt-3 fs-15 fw-medium">Giriş Yapın</p>
                    </div>
                </div>
            </div>
            <!-- end row -->
                        ...
                        <div class="card-body p-4">
                            <div class="p-2 mt-4">
                                <form action="{{ route('admin.login') }}" method="post">
                                    ...
                                    <div class="mb-3">
                                        <div class="float-end">
                                            <a href="auth-pass-reset-basic.html" class="text-muted">Şifremi Unuttum?</a>
                                        </div>
...
<!-- password-addon init -->
<script src="../backend/assets/js/pages/password-addon.init.js"></script>
</body>
