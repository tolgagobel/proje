            ...
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-8">
                    <div class="text-center">
                        <img src="../backend/assets/images/error400-cover.png" alt="error img" class="img-fluid">
                        <div class="mt-3">
                            <h3 class="text-uppercase">Sayfa Bulunamadı 😭</h3>
                            <p class="text-muted mb-4">Aradığınız sayfa mevcut değil!</p>
                            <a href="{{ route('main') }}" class="btn btn-success"><i class="mdi mdi-home me-1"></i>Ana Sayfa</a>
                        </div>
                    </div>
                </div><!-- end col -->
            </div>
